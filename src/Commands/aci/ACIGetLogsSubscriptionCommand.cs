...
namespace AzureOpsCLI.Commands.vm
{
    ...
    public class ACIGetLogsSubscriptionCommand : AsyncCommand<ACIGetLogsAllCommand.Settings>
    {
        private readonly IACIService _aciService;
        private readonly ISubscritionService _subscriptionService;

        public ACIGetLogsSubscriptionCommand(IACIService aciService, ISubscritionService subscritionService)
        {
        ...
        public override async Task<int> ExecuteAsync(CommandContext context, ACIGetLogsAllCommand.Settings settings)
        {
