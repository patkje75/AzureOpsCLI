...
{
    public class VMSSStopSubscriptionCommand : AsyncCommand
    {
        private readonly IVMSSService _vmssService;
        private readonly ISubscritionService _subscriptionService;

        public VMSSStopSubscriptionCommand(IVMSSService vmssService, ISubscritionService subscritionService)
        {
        ...
        public override async Task<int> ExecuteAsync(CommandContext context)
        {
            ...
            var selectedVMs = AnsiConsole.Prompt(
                new MultiSelectionPrompt<string>()
                    ...
                    .InstructionsText("[grey](Press [blue]<space>[/] to toggle a Scale Set, [green]<enter>[/] to stop selected Scale Set)[/]")
                    .AddChoices(vmNames));
