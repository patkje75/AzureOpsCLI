...
namespace AzureOpsCLI.Commands.vm
{
    ...
    public class VMRestartSubscriptionCommand : AsyncCommand
    {
        private readonly IVMService _computeService;
        private readonly ISubscritionService _subscriptionService;

        public VMRestartSubscriptionCommand(IVMService computeService, ISubscritionService subscritionService)
        {
